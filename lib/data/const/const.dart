...
const String exchangeBillEndpoint = apiVersion + '/gameplay/exchangeBillEndpoint';
const String selectBillExchangeRatesEndpoint = apiVersion + '/gameplay/selectBillExchangeRatesEndpoint';
const String selectBillExchangesEndpoint = apiVersion + '/gameplay/selectBillExchangesEndpoint';
const String selectTelephoneOperatorsEndpoint = apiVersion + '/gameplay/selectTelephoneOperatorsEndpoint';