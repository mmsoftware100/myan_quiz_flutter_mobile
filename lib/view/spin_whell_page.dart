...
// //               snapshot.hasData ? BasicScore(int.parse(snapshot.data.toString())) : Container(),
// //             )
// //           ],
// //         ),
// //       ),
...
//               stream: _dividerController.stream,
//               builder: (context, snapshot) =>
//               snapshot.hasData ? RouletteScore(int.parse(snapshot.data.toString())) : Container(),
//             ),
//             SizedBox(height: 30),
//             // new RaisedButton(
...
//                 ),
//                 child: Text("ကံစမ်းခွင့် (၃) ကြိမ်",style: TextStyle(
